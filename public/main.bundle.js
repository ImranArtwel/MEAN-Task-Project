...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_task_task_component__ = __webpack_require__("../../../../../src/app/components/task/task.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_new_task_new_task_component__ = __webpack_require__("../../../../../src/app/components/new-task/new-task.component.ts");
...
var appRoutes = [
    ...
    { path: 'addtask', component: __WEBPACK_IMPORTED_MODULE_16__components_new_task_new_task_component__["a" /* NewTaskComponent */] },
    { path: 'viewtask', component: __WEBPACK_IMPORTED_MODULE_11__components_tasks_tasks_component__["a" /* TasksComponent */] },
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_16__components_new_task_new_task_component__["a" /* NewTaskComponent */]
        ],
        imports: [
...
module.exports = "<div class = \"jumbotron text-centre\">\n  <br /><br />\n  <p>To add click on AddTask button and to View current tasks click on ViewTasks button</p>\n  <br /><br />\n  <div align=\"center\">\n    <a class=\"btn btn-primary\" [routerLink]=\"['/addtask']\">AddTask</a>\n    <a class=\"btn btn-default\" [routerLink]=\"['/viewtask']\">ViewTasks</a>\n  </div>\n</div>\n"
...
module.exports = "<div class = \"jumbotron text-centre\">\n  <h1>MEAN Task App</h1>\n  <p>This is a MEAN App that implements a simple CRUD for tasks</p>\n</div>\n"
...
module.exports = "<div class=\"container\">\r\n  <h2 class=\"page-header\">Login</h2>\r\n<form #myForm=\"ngForm\" (submit)=\"onLogin(myForm)\">\r\n <div class=\"form-group\">\r\n   <label>Username</label>\r\n   <input type=\"text\" [(ngModel)]=\"username\" name =\"username\" class=\"form-group\">\r\n </div>\r\n <div class=\"form-group\">\r\n   <label>Password</label>\r\n   <input type=\"password\" [(ngModel)]=\"password\" name =\"password\"class=\"form-group\">\r\n </div>\r\n <div class=\"form-group\">\r\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Login\">\r\n </div>\r\n</form>\r\n</div>\r\n"
    ...
    LoginComponent.prototype.onLogin = function (form) {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Invalid login credentials', { cssClass: 'alert-danger', timeout: 2000 });
...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.onLogout = function () {
        ...
        return false; // avoid returning direct to home ='/'
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__task_interface__ = __webpack_require__("../../../../../src/app/task.interface.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__task_interface___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__task_interface__);
...
var TaskComponent = (function () {
    function TaskComponent(authService, flashMessage) {
        this.authService = authService;
        this.flashMessage = flashMessage;
    ...
    TaskComponent.prototype.onUpdate = function () {
        var _this = this;
        this.authService.updateTask(this.task._id, this.editValue)
            .subscribe(function (task) {
            _this.task.content = _this.editValue;
            _this.editValue = '';
        });
        this.allowEdit = false;
        return false;
    };
    TaskComponent.prototype.onCancel = function () {
        this.editValue = '';
        this.allowEdit = false;
        return false;
    };
    TaskComponent.prototype.onDelete = function () {
        var _this = this;
        this.authService.deleteTask(this.task._id).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Task deleted', { cssClass: 'alert-success', timeout: 3000 });
            }
            else
                _this.flashMessage.show('Error while deleting task', { cssClass: 'alert-danger', timeout: 3000 });
        });
        location.reload();
        return false;
    };
...
__decorate([
    ...
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__task_interface__["Task"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__task_interface__["Task"]) === "function" && _a || Object)
...
var TasksComponent = (function () {
    function TasksComponent(validateService, flashMessage, authService, router) {
        this.validateService = validateService;
        this.flashMessage = flashMessage;
        this.authService = authService;
        this.router = router;
...
var AuthService = (function () {
    ...
    AuthService.prototype.updateTask = function (id, newTask) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        var body = JSON.stringify({ content: newTask });
        headers.append('Content-Type', 'application/json');
